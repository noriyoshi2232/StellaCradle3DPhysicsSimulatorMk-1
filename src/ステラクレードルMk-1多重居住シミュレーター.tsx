...
const App: React.FC = () => {
  ...
  return (
    <div className="w-full h-screen bg-gray-900 relative overflow-hidden">
      {/* StellaCradle™ 商標ヘッダー */}
      <div className="absolute top-0 left-0 right-0 bg-gradient-to-r from-blue-900 to-blue-700 text-white p-4 z-50 shadow-lg">
        <div className="flex justify-between items-center">
          ...
          <div className="text-right">
            ...
            <p className="text-blue-300 text-xs mt-1">
              © 2024 StellaCradle Technologies
            </p>
          </div>
        </div>
      </div>
      ...
      {/* 制御パネル */}
      <div className="absolute top-24 left-4 bg-gray-800 bg-opacity-90 p-6 rounded-lg shadow-lg w-80 max-h-[calc(100vh-8rem)] overflow-y-auto">
      ...
      {/* 物理情報パネル */}
      {showPhysics && (
        <div className="absolute top-24 right-4 physics-panel p-4 rounded-lg w-80">
      ...
      {showSystemInfo && (
        <div className="absolute bottom-4 left-4 physics-panel p-4 rounded-lg w-80">
          ...
          <div className="space-y-2 text-sm text-gray-300">
            <div>実験装置: StellaCradle™ Mk-1</div>
